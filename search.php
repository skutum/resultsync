...
<html>
<head>
<title>Result Sync | Search</title>
    ...
    <div id="page-container">
        ...
        <div id="content">
            <?php
                ...
                $sql = "SELECT COUNT(*) FROM results WHERE MATCH(title, description) AGAINST ('".mysql_real_escape_string($_GET['search'])."' IN BOOLEAN MODE)";
                ...
                $query = "SELECT id, title, imageOne, numberOfViews, rating FROM  `results` WHERE MATCH(title, description) AGAINST ('".mysql_real_escape_string($_GET['search'])."') ORDER BY  `dateCreated` DESC LIMIT $offset, $rowsperpage";
